...
{
    public class PrecursorSubEngine : VehicleFramework.Engines.ModVehicleEngine
    {
        public MotorWheel downup;
        public MotorWheel leftright;
        public MotorWheel backforth;
        protected override float FORWARD_TOP_SPEED => 2500;
        ...
        protected override float FORWARD_ACCEL => FORWARD_TOP_SPEED / 5.33f;
